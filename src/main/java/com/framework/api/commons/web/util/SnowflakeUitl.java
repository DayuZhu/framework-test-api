 ...
 */
public class SnowflakeUitl implements Serializable {
     ...
     */
    public SnowflakeUitl(long workerId, long datacenterId) {
     ...
     * @param workerId         终端ID
     * @param datacenterId     数据中心ID
     * @param isUseSystemClock 是否使用{@link SystemClockUtil} 获取当前时间戳
     */
    public SnowflakeUitl(long workerId, long datacenterId, boolean isUseSystemClock) {
    ...
    private long genTime() {
        return this.useSystemClock ?  SystemClockUtil.now() : System.currentTimeMillis();
    }
    // ------------------------------------------------------------------------------------------------------------------------------------ Private method end

    public static String getSnowflakeId() {
        SnowflakeUitl idWorker = new SnowflakeUitl(3, 23);
